...
//        Orders ordersDB = orderMapper.getByNumber(outTradeNo);
    ...
    @Override
    public PageResult historyOrders(int page1, int pageSize, Integer status) {
        log.info("历史订单分页查询,{},{},{},{}", page1, pageSize, status, BaseContext.getCurrentId());
...
//                    new BigDecimal(0.01));//原订单金额
    ...
    public void oneMoreOrder(Long id) {
        ...
        orderMapper.addShoppingCarts(shoppingCarts);
